...
const cases = [
  {
    no: 'CASE 01',
    sector: '区域商贸集团 / ERP 与业财协同',
    title: '让 ERP 项目从“安装软件”回到“重建业务协同”',
    challenge: '多业态、多组织并行，业务系统与财务系统分离，采购、销售、仓配和核算中的特殊场景长期依赖人工解释。',
    role: 'IT 咨询与甲方项目管理',
    moves: ['梳理采购、销售、仓配与财务映射', '统一档案、流程、权限和特殊场景', '组织数据准备、系统切换和部门复盘'],
    value: '项目阶段推动业务数据进入财务系统，支持按专柜生成利润表；返利自动计算进入上线验证，为应收、ROI 与绩效管理补齐数据基础。',
    facts: ['4 大业务域', '多部门协同', '从需求到切换'],
  },
  {
    no: 'CASE 02',
    sector: '区域连锁超市 / 品类管理',
  ...
  return (
    <main id="top">
      ...
      <section className="section difference-section">
        <div className="section-intro two-col on-dark">
          <div><p className="section-code">05 / WHY JIANYI</p><h2>简益站在甲方一侧，把专业语言转成共同工作语言。</h2></div>
      ...
      <section className="section section-white" id="method">
        <div className="section-intro two-col">
          <div><p className="section-code">06 / HOW WE WORK</p><h2>五步工作法：从管理课题到改进闭环。</h2></div>
      ...
      <section className="section topic-section">
        <div className="section-intro two-col">
          <div><p className="section-code">07 / QUESTIONS WE STUDY</p><h2>我们持续研究的，是零售企业每天需要做出的判断。</h2></div>
      ...
      <section className="section about-section" id="about">
        <div className="about-title">
          <p className="section-code">08 / ABOUT JIANYI</p>
      ...
      <section className="section section-white faq-section">
        <div className="section-intro"><p className="section-code">09 / BEFORE WE START</p><h2>从一次有准备的项目沟通开始。</h2></div>
